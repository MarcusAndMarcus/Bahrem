...
function esquema(db) {
  ...
  CREATE TABLE IF NOT EXISTS lancamentos (
    ...
    estornado_em TEXT, estornado_por INTEGER);
  ...
  /* Uma comanda pode fechar em mais de uma forma: metade no cartão, o resto em
     dinheiro. Por isso é tabela, não coluna. A soma dos valores tem de dar o
     total da comanda, e o servidor recusa o fechamento se não der. */
  CREATE TABLE IF NOT EXISTS pagamentos (
    id INTEGER PRIMARY KEY,
    comanda_id INTEGER NOT NULL REFERENCES comandas(id) ON DELETE CASCADE,
    forma TEXT NOT NULL, valor_cent INTEGER NOT NULL,
    recebido_cent INTEGER, troco_cent INTEGER,
    criado_em TEXT NOT NULL, por INTEGER);
